...
\subsection{$d$-separation (blocking) in Bayesian networks}
...
Conditions (2) and (3) of the front-door definition are overly restrictive: e.g. nested combinations of back-door and front-door conditions are permissible (see [XXX LATER] for a more general set of conditions).
