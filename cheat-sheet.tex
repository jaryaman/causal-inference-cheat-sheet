...
\end{center}
\caption{Graphical conditions for identification of causal effect (Theorem 4.3.1 Causality). Satisfying at least one renders the causal effect identifiable, whereas satisfying none implies unidentifiability of the causal effect.}
